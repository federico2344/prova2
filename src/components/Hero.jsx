...
export default function Hero() {
  ...
  return (
    <section id="top" className="bg-cream">
      <div className="container-x grid gap-8 pt-32 pb-16 md:grid-cols-2 md:items-center md:gap-14 md:pt-40 md:pb-16">
        {/* Testo */}
        ...
        <div className="order-1 md:order-2">
          <div className="relative">
            <img
              ...
              fetchpriority="high"
              decoding="async"
              className="h-64 w-full rounded-2xl object-cover shadow-xl ring-1 ring-charcoal/10 sm:h-80 md:h-[52vh]"
            />
